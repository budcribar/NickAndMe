#!/usr/bin/env python3
"""
Extract Stage 1 scene bible from an existing full blueprint (nickandme.json)
...
Usage (from repo root):
  ...
  python docs/two_stage_adaptation/extract_stage1_from_blueprint.py --blueprint nickandme.json --out nickandme.scenes.json
"""
...
def main() -> int:
    ...
    ap.add_argument(
        "--blueprint",
        default=str(ROOT / "nickandme.json"),
        help="Full production blueprint path",
    )
    ap.add_argument(
        "--out",
    ...
    stage1: Dict[str, Any] = {
        ...
        "adaptation_notes": (
            "Extracted from full blueprint (legacy nickandme.json). "
